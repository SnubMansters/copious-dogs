	...
	public void registerRecipes()
	{
		...
		for (int i = 0; i < 16; i++) {
			...
			GameRegistry.addShapelessRecipe(new ItemStack(CopiousDogsItems.dogCollar, 1, i), 
					new ItemStack((Item)Item.itemRegistry.getObject("dye"), 1, ItemDogCollar.getDyeFromItem(i)), new ItemStack(CopiousDogsItems.dogCollar, 0, OreDictionary.WILDCARD_VALUE));
		}
	}
}
