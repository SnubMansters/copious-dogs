...
public class ModelAmericanBulldog extends ModelDog {

	public ModelAmericanBulldog() {
		
		super("american_bulldog");
		textureWidth = 64;
		textureHeight = 32;
