...
public class ModelAmericanBulldogPup extends ModelDog {

	public ModelAmericanBulldogPup() {
		
		super("american_bulldog_pup");
		textureWidth = 64;
		textureHeight = 32;
		...
		Body.addBox(-4F, -2F, -3F, 4, 7, 4);
		Body.setRotationPoint(1.5F, 18F, -4F);
		Body.setTextureSize(64, 32);
		Body.mirror = true;
		setRotation(Body, 1.570796F, 0F, 0F);
		Mane = new ModelRenderer(this, 21, 0);
		Mane.addBox(-4F, -3F, -3F, 4, 4, 1);
		Mane.setRotationPoint(1.5F, 19F, -3F);
		...
		Leg2.setRotationPoint(1F, 21F, 0.5F);
