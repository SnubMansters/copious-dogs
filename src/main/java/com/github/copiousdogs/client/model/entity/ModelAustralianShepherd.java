...
public class ModelAustralianShepherd extends ModelDog {

	public ModelAustralianShepherd() {
		
		super("australian_shepherd");
		textureWidth = 64;
		textureHeight = 32;
		...
		Leg1.setRotationPoint(-2.5F, 18F, 6F);
		Leg1.setTextureSize(64, 32);
		Leg1.mirror = true;
		setRotation(Leg1, 0F, 0F, 0F);
		Leg2 = new ModelRenderer(this, 0, 18);
		Leg2.addBox(-1F, 0F, -1F, 2, 6, 2);
		Leg2.setRotationPoint(0.5F, 18F, 6F);
		...
		Tail.setRotationPoint(-1F, 12.3F, 7F);
