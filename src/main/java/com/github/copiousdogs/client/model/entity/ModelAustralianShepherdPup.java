...
public class ModelAustralianShepherdPup extends ModelDog {

	public ModelAustralianShepherdPup() {
		
		super("australian_shepherd_pup");
		textureWidth = 64;
		textureHeight = 32;
		...
		Body = new ModelRenderer(this, 20, 11);
		...
		Leg1.setRotationPoint(-1.5F, 21F, 0F);
		...
		Tail.setRotationPoint(-0.5F, 18.1F, 0.5F);
