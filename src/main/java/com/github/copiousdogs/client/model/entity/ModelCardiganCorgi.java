...
public class ModelCardiganCorgi extends ModelDog {

	public ModelCardiganCorgi() {
		
		super("cardigan_corgi");
		textureWidth = 64;
		textureHeight = 32;
