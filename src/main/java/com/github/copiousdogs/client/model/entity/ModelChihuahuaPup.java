...
public class ModelChihuahuaPup extends ModelDog
{
	public ModelChihuahuaPup()
	{
		super("chihuahua_pup");
		textureWidth = 64;
		textureHeight = 32;
