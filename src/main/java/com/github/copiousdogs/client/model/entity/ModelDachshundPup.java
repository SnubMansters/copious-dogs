...
public class ModelDachshundPup extends ModelDog {

	public ModelDachshundPup() {
		...
		Leg1.setRotationPoint(-1.5F, 22F, -1.5F);
		Leg1.setTextureSize(64, 32);
		Leg1.mirror = true;
		setRotation(Leg1, 0F, 0F, 0F);
		Leg2 = new ModelRenderer(this, 0, 14);
		Leg2.addBox(-1F, 0F, -1F, 1, 2, 1);
		Leg2.setRotationPoint(0.5F, 22F, -1.5F);
