...
public class ModelEskimoSpitzPup extends ModelDog {

	public ModelEskimoSpitzPup() {
		
		super("eskimo_spitz_pup");
		textureWidth = 64;
		textureHeight = 32;

		WolfHead = new ModelRenderer(this, 0, 0);
		WolfHead.addBox(-3F, -3F, -2F, 5, 5, 4);
		WolfHead.setRotationPoint(-0.5F, 19.5F, -7F);
		WolfHead.setTextureSize(64, 32);
		WolfHead.mirror = true;
		setRotation(WolfHead, 0F, 0F, 0F);
		Body = new ModelRenderer(this, 18, 14);
		Body.addBox(-4F, -2F, -3F, 3, 2, 2);
		Body.setRotationPoint(1.5F, 19.5F, -1F);
		Body.setTextureSize(64, 32);
		Body.mirror = true;
		setRotation(Body, 1.570796F, 0F, 0F);
		Mane = new ModelRenderer(this, 21, 0);
		Mane.addBox(-4F, -3F, -3F, 3, 3, 3);
		Mane.setRotationPoint(1.5F, 20.3F, -3F);
		Mane.setTextureSize(64, 32);
		Mane.mirror = true;
		setRotation(Mane, 1.570796F, 0F, 0F);
		Leg1 = new ModelRenderer(this, 0, 18);
		Leg1.addBox(-1F, 0F, -1F, 1, 2, 1);
		Leg1.setRotationPoint(-1.4F, 22F, -1.5F);
		Leg1.setTextureSize(64, 32);
		Leg1.mirror = true;
		setRotation(Leg1, 0F, 0F, 0F);
		Leg2 = new ModelRenderer(this, 0, 18);
		Leg2.addBox(-1F, 0F, -1F, 1, 2, 1);
		Leg2.setRotationPoint(0.4F, 22F, -1.5F);
		...
		Tail.setRotationPoint(-0.5F, 21.5F, -1.2F);
		Tail.setTextureSize(64, 32);
		Tail.mirror = true;
		setRotation(Tail, -2.810863F, 0F, 0F);
		Ear1 = new ModelRenderer(this, 10, 10);
		Ear1.addBox(-3F, -5F, 0F, 2, 2, 1);
		Ear1.setRotationPoint(-0.5F, 19.5F, -7F);
		Ear1.setTextureSize(64, 32);
		Ear1.mirror = true;
		setRotation(Ear1, 0F, 0F, 0F);
		Ear2 = new ModelRenderer(this, 10, 10);
		...
		Nose.setRotationPoint(0F, 19.5F, -6F);
