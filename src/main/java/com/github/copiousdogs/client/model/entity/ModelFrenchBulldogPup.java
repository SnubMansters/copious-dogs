...
public class ModelFrenchBulldogPup extends ModelDog
{
	public ModelFrenchBulldogPup()
	{
		super("french_bulldog_pup");
		textureWidth = 64;
		textureHeight = 32;

		WolfHead = new ModelRenderer(this, 0, 0);
		WolfHead.addBox(-3F, -3F, -2F, 6, 5, 4);
		WolfHead.setRotationPoint(-1.5F, 19.5F, -6F);
		...
		Leg1.setRotationPoint(-2F, 21F, -1F);
		...
		Leg3.setRotationPoint(-2F, 21F, -4F);
