...
public class ModelGoldenRetrieverPup extends ModelDog
{
	public ModelGoldenRetrieverPup()
	{
		super("golden_retriever_pup");
		textureWidth = 64;
		textureHeight = 32;
		...
		Leg4.setRotationPoint(1F, 20F, -4F);
