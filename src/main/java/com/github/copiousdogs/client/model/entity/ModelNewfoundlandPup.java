...
public class ModelNewfoundlandPup extends ModelDog {

	public ModelNewfoundlandPup() {
		
		super("newfoundland_pup");
		textureWidth = 64;
		textureHeight = 32;

		WolfHead = new ModelRenderer(this, 0, 0);
		WolfHead.addBox(-3F, 1F, -2F, 6, 7, 6);
		WolfHead.setRotationPoint(-1F, 9.5F, -8F);
		...
		Tail.addBox(-1F, 0F, -1F, 2, 6, 2);
		Tail.setRotationPoint(-1F, 16.2F, 3.2F);
		Tail.setTextureSize(64, 32);
		Tail.mirror = true;
		setRotation(Tail, 0.6095687F, 0F, 0F);
		Ear1 = new ModelRenderer(this, 26, 20);
		Ear1.addBox(-3F, -5F, 0F, 1, 4, 3);
		Ear1.setRotationPoint(-2F, 15.5F, -8.5F);
		Ear1.setTextureSize(64, 32);
		Ear1.mirror = true;
		setRotation(Ear1, 0F, 0F, 0F);
		Ear2 = new ModelRenderer(this, 26, 20);
		...
		Nose.setRotationPoint(-0.5F, 14.5F, -7.5F);
