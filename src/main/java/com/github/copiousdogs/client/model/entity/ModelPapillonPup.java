...
public class ModelPapillonPup extends ModelDog {

	public ModelPapillonPup() {
		...
		WolfHead.setRotationPoint(0F, 20F, -6F);
		WolfHead.setTextureSize(64, 32);
		WolfHead.mirror = true;
		setRotation(WolfHead, 0F, 0F, 0F);
		Body = new ModelRenderer(this, 16, 7);
		Body.addBox(-4F, -2F, -3F, 3, 4, 2);
		Body.setRotationPoint(1.5F, 19F, -4F);
		Body.setTextureSize(64, 32);
		Body.mirror = true;
		setRotation(Body, 1.570796F, 0F, 0F);
		Mane = new ModelRenderer(this, 15, 0);
		Mane.addBox(-4F, -3F, -3F, 3, 2, 1);
