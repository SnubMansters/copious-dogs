...
public class ModelPitbull extends ModelDog {
	...
	public ModelPitbull() {
		...
		WolfHead.setRotationPoint(-0.5F, 10.5F, -7F);
		WolfHead.setTextureSize(64, 32);
		WolfHead.mirror = true;
		setRotation(WolfHead, 0F, 0F, 0F);
		Body = new ModelRenderer(this, 21, 8);
		Body.addBox(-4F, -2F, -3F, 7, 14, 6);
		Body.setRotationPoint(0F, 14F, -4F);
		Body.setTextureSize(64, 32);
		Body.mirror = true;
		setRotation(Body, 1.570796F, 0F, 0F);
		Mane = new ModelRenderer(this, 21, 0);
		Mane.addBox(-4F, -3F, -3F, 7, 6, 1);
		...
		Leg1.setRotationPoint(-2.5F, 17F, 6F);
		Leg1.setTextureSize(64, 32);
		Leg1.mirror = true;
		setRotation(Leg1, 0F, 0F, 0F);
		Leg2 = new ModelRenderer(this, 0, 18);
		Leg2.addBox(-1F, 0F, -1F, 2, 7, 2);
		Leg2.setRotationPoint(1.5F, 17F, 6F);
