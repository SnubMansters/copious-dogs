...
public class ModelPomeranian extends ModelDog {
	...
	public ModelPomeranian() {
		...
		WolfHead.setRotationPoint(-0.5F, 18.5F, -6F);
		WolfHead.setTextureSize(64, 32);
		WolfHead.mirror = true;
		setRotation(WolfHead, 0F, 0F, 0F);
		Body = new ModelRenderer(this, 18, 10);
		Body.addBox(-4F, -2F, -3F, 4, 3, 4);
		Body.setRotationPoint(0.5F, 18.5F, 0F);
		Body.setTextureSize(64, 32);
		Body.mirror = true;
		setRotation(Body, 1.570796F, 0F, 0F);
		Mane = new ModelRenderer(this, 15, 0);
		Mane.addBox(-4F, -3F, 0F, 5, 4, 5);
		Mane.setRotationPoint(0F, 22F, -3F);
		Mane.setTextureSize(64, 32);
		Mane.mirror = true;
		setRotation(Mane, 1.570796F, 0F, 0F);
		Leg1 = new ModelRenderer(this, 0, 12);
		Leg1.addBox(-0.5F, 0F, -1F, 1, 3, 1);
		Leg1.setRotationPoint(-2.5F, 21F, 0F);
		Leg1.setTextureSize(64, 32);
		Leg1.mirror = true;
		setRotation(Leg1, 0F, 0F, 0F);
		Leg2 = new ModelRenderer(this, 0, 12);
		Leg2.addBox(-1.5F, 0F, -1F, 1, 3, 1);
		Leg2.setRotationPoint(0.5F, 21F, 0F);
