...
public class ModelPomeranianPup extends ModelDog {

	public ModelPomeranianPup() {
		
		super("pomeranian_pup");
		textureWidth = 64;
		textureHeight = 32;

		WolfHead = new ModelRenderer(this, 0, 0);
		WolfHead.addBox(-3F, -3F, -2F, 4, 4, 3);
		WolfHead.setRotationPoint(-0.5F, 20.5F, -6F);
		WolfHead.setTextureSize(64, 32);
		WolfHead.mirror = true;
		setRotation(WolfHead, 0F, 0F, 0F);
		Body = new ModelRenderer(this, 18, 10);
		Body.addBox(-4F, -2F, -3F, 2, 2, 2);
		Body.setRotationPoint(1.5F, 19.5F, -2F);
		Body.setTextureSize(64, 32);
		Body.mirror = true;
		setRotation(Body, 1.570796F, 0F, 0F);
		Mane = new ModelRenderer(this, 15, 0);
		Mane.addBox(-4F, -3F, 0F, 3, 2, 3);
		Mane.setRotationPoint(1F, 23F, -3F);
		Mane.setTextureSize(64, 32);
		Mane.mirror = true;
		setRotation(Mane, 1.570796F, 0F, 0F);
		Leg1 = new ModelRenderer(this, 0, 12);
		Leg1.addBox(-0.5F, 0F, -1F, 1, 2, 1);
		Leg1.setRotationPoint(-2.1F, 22F, -2.5F);
		Leg1.setTextureSize(64, 32);
		Leg1.mirror = true;
		setRotation(Leg1, 0F, 0F, 0F);
		Leg2 = new ModelRenderer(this, 0, 12);
		Leg2.addBox(-1.5F, 0F, -1F, 1, 2, 1);
		Leg2.setRotationPoint(0.1F, 22F, -2.5F);
		Leg2.setTextureSize(64, 32);
		Leg2.mirror = true;
		setRotation(Leg2, 0F, 0F, 0F);
		Leg3 = new ModelRenderer(this, 0, 12);
		Leg3.addBox(-1F, 0F, -1F, 1, 1, 1);
		Leg3.setRotationPoint(-2F, 23F, -4F);
		...
		Tail = new ModelRenderer(this, 7, 12);
		...
		Ear1.addBox(-3F, -5F, 0F, 1, 1, 1);
		Ear1.setRotationPoint(-0.5F, 21.5F, -7F);
		Ear1.setTextureSize(64, 32);
		Ear1.mirror = true;
		setRotation(Ear1, 0F, 0F, 0F);
		Ear2 = new ModelRenderer(this, 7, 8);
		Ear2.addBox(1F, -5F, 0F, 1, 1, 1);
		Ear2.setRotationPoint(-1.5F, 21.5F, -7F);
		Ear2.setTextureSize(64, 32);
		Ear2.mirror = true;
		setRotation(Ear2, 0F, 0F, 0F);
		Nose = new ModelRenderer(this, 0, 8);
		Nose.addBox(-2F, 0F, -5F, 2, 2, 1);
		Nose.setRotationPoint(-0.5F, 19.5F, -4F);
